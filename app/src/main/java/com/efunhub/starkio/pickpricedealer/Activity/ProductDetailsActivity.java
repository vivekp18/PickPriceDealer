...
public class ProductDetailsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //produdustDetailsLayout

    //private CheckConnectivity checkConnectivity;
    //private boolean connectivityStatus = true;
    private RelativeLayout produdustDetailsLayout;
    ...
    private void init() {
        ...
        produdustDetailsLayout=(RelativeLayout) findViewById(R.id.produdustDetailsLayout);
    ...
    private void setSnackbarMessage(String status,boolean showBar) {
        ...
        snackbar = Snackbar
                .make(produdustDetailsLayout, internetStatus, Snackbar.LENGTH_LONG)
