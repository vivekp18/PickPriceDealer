...
public class ProductSpecificationActivity extends AppCompatActivity {
    ...
    //private CheckConnectivity checkConnectivity;
    //private boolean connectivityStatus = true;
    private RelativeLayout proSpecficationLayout;
    ...
    private void init() {
        ...
        proSpecficationLayout=(RelativeLayout) findViewById(R.id.proSpecficationLayout);
    ...
    private void setSnackbarMessage(String status,boolean showBar) {
        ...
        snackbar = Snackbar
                .make(proSpecficationLayout, internetStatus, Snackbar.LENGTH_LONG)
